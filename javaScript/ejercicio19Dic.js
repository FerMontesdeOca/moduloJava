...
const newArray = RickAndMortyCharacters.results;
...
//Array para Male
const maleArray =(array)=>{
    const male = [];
    for (const iterator of array) {
        if(iterator.gender == 'Male'){
            const instancia = new gender(iterator)
            male.push(instancia);
        }
    }
    return male;
}
console.log(maleArray(newArray));

//Array Female
const femaleArray =(array)=>{
    const female = [];
    for (const iterator of array) {
        if(iterator.gender == 'Female'){
            const instancia = new gender(iterator)
            female.push(instancia);
        }
    }
    return female;
}
console.log(femaleArray(newArray));
